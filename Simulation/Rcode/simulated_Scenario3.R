######### For this Scenario,  the raw gene expressions, domain labels and spatial coordinates are from 
######### all three DLFPC tissue slides (ID: 151673, 151674 and 151675) from the last donor (Visium platform)

setwd("./Simulation/simulated_datasets/")
load('simulated_datasets_Scenario3.rds')
