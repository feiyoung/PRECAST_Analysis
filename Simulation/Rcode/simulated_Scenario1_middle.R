######### For this Scenario  with middle batch effects, cluster label and spatial coordinates are generated from a Potts model.
...
load('simulated_datasets_Scenario1_middle.rds')
